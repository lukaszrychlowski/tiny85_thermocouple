...
const int Centigrade = 12;
const int Minus = 12;
>>>>>>> 340b1c92b026dc5a051e0dc37fed53547c5817c8
...
//     for (int i = 1000; i > 0; i = i / 10){
//         char digit = get_digit(temp, i);
//         if (digit == 0 && i > 1) digit = space;
//         oled_set_cursor(line, col);
//         oled_print_char(digit, col, line);
//         col = col + 1;
//     }
//     oled_set_cursor(line, col);
//     oled_print_char(degree, col, line);
//     col = col + 1;
//     oled_set_cursor(line, col);
